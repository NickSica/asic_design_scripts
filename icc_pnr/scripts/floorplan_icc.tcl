...
create_floorplan -core_utilization 0.7 -left_io2core 5 -bottom_io2core 5 -right_io2core 5 -top_io2core 5
...
##Create GND ring
create_rectangular_rings  -nets $ground_net \
...
## Create VDD Ring
create_rectangular_rings -nets $power_net \
...
set_preroute_drc_strategy -no_design_rule
