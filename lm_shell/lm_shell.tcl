...
if { $pdk == "saed32nm" } { 
    ...
    set lib sky30hd
    create_physical_lib -technology $techfile $lib 
    ...
    set gds_files ~/pdks/sky130hd/gds/sky130_fd_sc_hd.gds
    set lef_files ~/pdks/sky130hd/lef/sky130_fd_sc_hd_merged.lef
    ...
    set layermap ~/pdks/sky130hd/gds/gds_layers.layermap
    ...
    create_frame 
    #-convert_metal_blockage_to_zero_spacing {{M1 0 all}}
